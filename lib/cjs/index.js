...
function Challenge(props) {
    ...
    var _a = require$$0.useState(slider.default), sliderVariant = _a[0], setSliderVariant = _a[1];
    var _b = require$$0.useState(false), solving = _b[0], setSolving = _b[1];
    var _c = require$$0.useState(false), submittedResponse = _c[0], setSubmittedResponse = _c[1];
...
function Card(props) {
    ...
    var _a = require$$0.useState(Math.random()), key = _a[0], setKey = _a[1];
    var _b = require$$0.useState(false), captcha = _b[0], setCaptcha = _b[1];
...
function Anchor(props) {
    ...
    var _a = require$$0.useState(false), open = _a[0], setOpen = _a[1];
...
var SliderCaptcha = function (props) {
    var _a = require$$0.useState(false), verified = _a[0], setVerified = _a[1];
